    ...
    <style>
        ...
        * {
        ...
        .semana-info {
            ...
            background: rgba(66,232,255,.025);
        ...
        .trabajo-card:hover .imagen-trabajo {
        ...
        <section class="content">
            ...
            <div
                ...
                <p>
                    ...
                    Agrega el primer proyecto para comenzar a construir
                    tu portafolio académico.
                </p>
            ...
            <div
                ...
                <c:forEach var="trabajo" items="${trabajos}" varStatus="iter"><article
                    ...
                    <div class="trabajo-body">
                        ...
                        <div
                                class="recursos"
                                style="${(not empty trabajo.enlace or not empty trabajo.archivo) ? '' : 'display:none'}">
